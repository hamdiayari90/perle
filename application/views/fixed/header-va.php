        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            if ($this->aauth->premission(2)) { ?>
                <li class="nav-item has-sub <?php if ($this->li_a == "stock") {
                    ...
                    <ul class="menu-content">
                    <li class="menu-item"><a href="<?= base_url('productcategory/warehouse'); ?>"><i class="ft-corner-left-down"></i>Historique des transferts</a>
                        ...
                        <li class="menu-item"><a
                            ...
                            <ul class="menu-content">
                                ...
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>aromes"
                                                    data-toggle="dropdown">Gérer les arômes</a>
                                </li>
