            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mobile-menu d-md-none mr-auto"><a
                            class="nav-link nav-menu-main hidden-xs" href="<?= base_url() ?>dashboard/"><i
                                class="ft-home font-large-1">Accueil</i></a></li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <li class="nav-item d-none d-md-block nav-link "><a href="<?= base_url() ?>pos_invoices/"
                                                                        class="btn btn-amber btn-md t_tooltip"
                                                                        title="Dashboard"><i
                                    class="icon-speedometer"><strong> Liste des ventes</strong></i> </a>
                    </li>
                    ...
                    <li class="nav-item d-none d-md-block nav-link "><a data-toggle="modal"
                                    ...
                                    class="icon-close"></i>Fermer la caisse</a>
                    </li>
