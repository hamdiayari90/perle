                        ...
                        <div class="col-6">
                            <div class="card-title">
                                ...
                                <select class="form-control" name="p_method" id="p_method">
                                    ...
                                    <option value='sodexespece'><?php echo $this->lang->line('sodexespece') ?></option>
                                </select></div>
                        </div>


                    </div>
                    <div class="row hidden" id="sodexopaye">
                        <div class="col-6">
                            <div class="form-group ">
                                <label for="montantcash"><?php echo $this->lang->line('Cash') ?>
                                </label>
                                <input type="text" class="form-control " name="montantcash" id="montantcash"
                                       onkeypress="return isNumber(event)"
                                       value="0.00"
                                       required>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group  text-g">
                                <label for="montantsodexo">Montant sodexo</label>
                                <input type="text" class="form-control " name="montantsodexo" id="montantsodexo"
                                       onkeypress="return isNumber(event)"
                                       value="0.00"
                                       required>
                            </div>
...
<script type="text/javascript">
    ...
    $("#p_method").on("change", function (e) {
        e.preventDefault();
        if($(this).val() =="sodexespece")
            $("#sodexopaye").removeClass("hidden"); 
        else{
            $("#sodexopaye").addClass("hidden");      
            $('#montantcash').val('0.00');
             $('#montantsodexo').val('0.00');
    ...
    $('#pos_basic_pay').on("click", function (e) {
        ...
        + '&employee=' + $("#employee option:selected").val()+'&montantcash='+ $('#montantcash').val()+'&montantsodexo='+ $('#montantsodexo').val();
        var action_url = $('#action-url').val();
        addObject(o_data, action_url);
        setTimeout(
            function () {
    ...
    $('#pos_basic_print').on("click", function (e) {
        ...
        $("#notify").removeClass("alert-danger").addClass("alert-primary").fadeIn();
        $("html, body").animate({scrollTop: $('body').offset().top - 100}, 1000);
        var o_data = $("#data_form").serialize() + '&p_amount=' + accounting.unformat($('#p_amount').val(), accounting.settings.number.decimal) + '&p_method=' + $("#p_method option:selected").val() + '&type=' + $(this).attr('data-type') + '&printnow=1' + '&account=' + $("#p_account option:selected").val() + '&employee=' + $("#employee option:selected").val()+'&montantcash='+ $('#montantcash').val()+'&montantsodexo='+ $('#montantsodexo').val();
        var action_url = $('#action-url').val();
        addObject(o_data, action_url);
        setTimeout(
            function () {
