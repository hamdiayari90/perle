<div class="content-body">
    <div class="card">
     ...
     8.(string)Product_Description, 9.(integer)Low_Stock_Alert_Quantity
                ...
                <a href="<?php echo base_url('userfiles/product/exemplaire_aromes.csv') ?>">
                    <strong>Exemplaire Arômes</strong></a>
                <pre>
Pour les Arômes (N'oubliez pas de choisir la catégorie Arômes, et ne JAMAIS supprimer cette catégorie):
     1. Code , 2. Libellé, 3.En stock, 4.Variants,

     5.Prix de vente (1kg), 6.Prix d'achat (1Kg), 7.Variants de stock, 8. Prix variants
</pre>
